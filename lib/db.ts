...
export function openDb(path = "data.sqlite") {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS bus_defs (id INTEGER PRIMARY KEY AUTOINCREMENT, source_type TEXT NOT NULL, label TEXT NOT NULL, params_json TEXT NOT NULL, enabled INTEGER NOT NULL DEFAULT 1, created_at INTEGER NOT NULL);
    ...
    CREATE TABLE IF NOT EXISTS upstream_calls (bucket INTEGER NOT NULL, label TEXT NOT NULL, calls INTEGER NOT NULL DEFAULT 0, transient INTEGER NOT NULL DEFAULT 0, rate_limited INTEGER NOT NULL DEFAULT 0, errors INTEGER NOT NULL DEFAULT 0, ms INTEGER NOT NULL DEFAULT 0, PRIMARY KEY (bucket, label));
    CREATE TABLE IF NOT EXISTS signal_digests (day TEXT PRIMARY KEY, digest TEXT NOT NULL, prev TEXT NOT NULL, count INTEGER NOT NULL, params_digest TEXT, created_at INTEGER NOT NULL);
    ...
    CREATE INDEX IF NOT EXISTS idx_upstream_calls_bucket ON upstream_calls(bucket);
  `);
