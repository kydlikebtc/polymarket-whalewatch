...
export const TERMS: TermEntry[] = [
  ...
  },
  {
    term: "信号密度（条/$1M）",
    detail:
      "发现页的 14 天趋势：每日共识推送数 ÷ 当日平均 6 小时窗口成交量（按 $1M 归一）。所有共识/拆单阈值（2 钱包 / $5k / 6h …）都隐含『当前成交量水位』假设——预测市场热度是周期性的，大盘量退潮后要么信号荒（共识永不成组）要么被迫降阈值引入噪声。密度随热度同跌 = 市场自身降温；热度稳定而密度独跌 = 阈值漂移需要重校。注意窗口每 5 分钟滚动、彼此重叠，成交量不能跨轮求和，取当日平均窗口量作为热度代理。",
  },
  {
    term: "聪明钱发现渠道",
    detail:
