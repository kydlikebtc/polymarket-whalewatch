...
- **Consensus** (`/consensus`) — a 90-second loop scans a 6h window (incrementally maintained since 2026-09-08) and fires `🔥 聪明钱共识` when ≥N whitelist wallets each net-buy ≥$X of the same outcome, alerting only on **formation and escalation**, never on repeats.
